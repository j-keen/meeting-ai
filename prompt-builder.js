...
## 앱이 하는 일
1. **실시간 분석**: 대화를 듣고 AI가 주기적으로 핵심을 정리해줍니다.
...
- analysisPrompt: "격차 해소"에 집중 — 놓친 포인트 감지, 핵심 구조화, 숨은 의도 파악
...
## What the app does
1. **Real-time Analysis**: Listens to conversations and AI periodically summarizes key points.
...
- analysisPrompt: Focus on "bridging gaps" — detect missed points, structure key takeaways, spot hidden agendas
