...
2. 후속 질문 (1회만): 상황에 맞는 집중 포인트 3~5개를 제안하고, "이 중에 빼고 싶은 거 있으세요?" 라고 물어보세요. 네거티브 선택 방식이 유저가 결정하기 편합니다.
...
2. Follow-up (just once): Suggest 3-5 focus points tailored to their situation, then ask "Is there anything you'd like to remove from these?" The negative selection approach makes it easier for users to decide.
