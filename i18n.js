...
const translations = {
  en: {
    ...
    'ds.step1': 'Situation',
    'ds.step2': 'People & Context',
    'ds.step3': 'Focus Points',
    'ds.step4': 'Ready',
    'ds.step1_greeting': 'Tell me about your situation. For example: "Client meeting tomorrow", "Hospital consultation today", "Presentation rehearsal" — anything like that.',
    'ds.step2_greeting': 'If there\'s someone you\'ll be with, tell me who and any background. Feel free to attach reference materials too.',
    'ds.step3_greeting': 'Let\'s decide what I should especially focus on. For example: "Catch contradictions", "Organize key terms", "Analyze my presentation structure".',
  ...
  ko: {
    ...
    'ds.step3': '집중 포인트',
    'ds.step4': '준비 완료',
    'ds.step1_greeting': '어떤 상황인지 알려주세요. 예를 들어 "내일 거래처 미팅", "오늘 병원 상담", "발표 리허설" 같은 거면 돼요.',
    'ds.step2_greeting': '상대방이 있다면 누구인지, 그리고 어떤 배경이 있는지 알려주세요. 참고할 자료가 있으면 첨부해주셔도 좋아요.',
    'ds.step3_greeting': '제가 특히 집중해서 잡아드릴 것을 정해볼까요? 예를 들어 "모순되는 말 잡아줘", "핵심 용어 정리해줘", "내 발표 구조 분석해줘" 같은 거요.',
