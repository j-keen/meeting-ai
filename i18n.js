...
const translations = {
  en: {
    ...
    'status.keys_note': 'High-accuracy STT always needs an OpenAI key: yours in settings, or OPENAI_API_KEY on the server.',
    'status.problem_cloud_no_key': 'No OpenAI key: enter one in Settings → OpenAI API key, or set OPENAI_API_KEY on the server.',
  ...
  ko: {
    ...
    'status.keys_note': '고정확도 STT는 항상 OpenAI 키가 필요합니다. 설정의 개인 키 또는 서버의 OPENAI_API_KEY.',
    'status.problem_cloud_no_key': 'OpenAI 키가 없습니다. 설정 → OpenAI API 키에 입력하거나 서버에 OPENAI_API_KEY를 설정하세요.',
