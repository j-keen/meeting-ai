...
const translations = {
  en: {
    ...
    'panel.analysis_context': 'Context',
    'panel.context_placeholder': 'Add context for better analysis (e.g. meeting goals, key topics, background info)...',
    'panel.context_save': 'Save',
    'panel.context_clear': 'Clear',
    ...
    // Export modal
    'export.title': 'AI Transcript Export',
  ...
  ko: {
    ...
    'panel.analysis_context': '맥락',
    'panel.context_placeholder': '분석에 도움이 될 맥락을 입력하세요 (예: 회의 목표, 주요 주제, 배경 정보)...',
    'panel.context_save': '저장',
    'panel.context_clear': '지우기',
