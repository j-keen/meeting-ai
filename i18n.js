...
const translations = {
  en: {
    ...
    'settings.gemini_key': 'Personal Gemini API key',
    ...
    'settings.openai_key': 'Personal OpenAI API key',
    'settings.openai_key_hint': 'Stored unencrypted in this browser only.',
  ...
  ko: {
    ...
    'settings.gemini_key': '개인 Gemini API 키',
    ...
    'settings.ai_provider_gemini': 'Google Gemini',
    'settings.ai_provider_openai': 'OpenAI (GPT)',
    'settings.openai_key': '개인 OpenAI API 키',
    'settings.openai_key_hint': '이 브라우저에만 암호화 없이 저장됩니다.',
