...
const translations = {
  en: {
    ...
    'settings.ai_provider_hint': 'Gemini uses the server proxy or your Gemini key; OpenAI uses your OpenAI key or the server\'s OPENAI_API_KEY.',
    ...
    'settings.cloud_stt_hint': 'OpenAI real-time transcription. Uses your OpenAI key from settings or the server\'s OPENAI_API_KEY. A 1-hour meeting costs roughly $0.18-0.36.',
  ...
  ko: {
    ...
    'settings.ai_provider_hint': 'Gemini는 서버 프록시 또는 회원님의 Gemini 키를 사용하고, OpenAI는 회원님의 OpenAI 키 또는 서버의 OPENAI_API_KEY를 사용합니다.',
    'settings.ai_provider_gemini': 'Google Gemini',
    'settings.ai_provider_openai': 'OpenAI (GPT)',
    ...
    'settings.cloud_stt_hint': 'OpenAI 실시간 전사. 설정의 OpenAI 키 또는 서버의 OPENAI_API_KEY를 사용. 1시간 회의 ≈ $0.18–0.36',
