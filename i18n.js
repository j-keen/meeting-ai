...
const translations = {
  en: {
    ...
    'ds.step4': 'Ready',
    'ds.step1_greeting': 'What conversation are you heading into?\nFor example: "Client meeting about the contract", "Medical consultation", "Job interview practice"',
    'ds.step2_greeting': 'Select attendees, reference sessions, or attach files if needed.',
  ...
  ko: {
    ...
    'ds.step3': '집중 포인트',
    'ds.step4': '준비 완료',
    'ds.step1_greeting': '어떤 대화에 들어가세요?\n예를 들어 "거래처 계약 미팅", "병원 상담", "면접 연습" 같은 거면 돼요.',
    'ds.step2_greeting': '참석자, 참고 세션, 파일이 있으면 선택해주세요.',
