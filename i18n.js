...
const translations = {
  en: {
    ...
    'record.live_recording': 'Recording',
    'record.live_paused': 'Paused',
    'record.live_aria': 'Recording status',
    ...
    'bottom.more_controls': 'More controls',
    ...
    'stt.connection_failed': 'Speech recognition lost its connection. Retrying automatically — please check your network.',
    ...
    'stt.kb_placeholder': 'Tap the mic on your keyboard and speak…',
    'stt.kb_send': 'Add',
    'stt.kb_hint': 'Use your keyboard microphone to dictate, then tap Add.',
    'stt.switch_to_keyboard': 'Speech recognition keeps failing. Switch to keyboard voice input?',
    'stt.switch_to_keyboard_action': 'Switch',
    'stt.on_device_active': 'On-device recognition active',
    'stt.high_accuracy': 'High-accuracy STT',
    'stt.high_accuracy_hint': 'Switch to OpenAI real-time transcription (~$0.003/min)',
    'stt.whisper_loading': 'Loading Whisper model…',
    'stt.whisper_transcribing': 'Transcribing…',
    ...
    'settings.gemini_key': 'Gemini API key — for Gemini analysis',
    'settings.gemini_placeholder': 'Enter API key',
    'settings.gemini_key_hint': 'Stored unencrypted in this browser only. Used when the server proxy is unavailable or rate-limited.',
    'settings.gemini_key_mode': 'Gemini key mode',
    'settings.gemini_key_mode_proxy': 'Server proxy only',
    'settings.gemini_key_mode_fallback': 'Proxy first, personal key as fallback',
    'settings.gemini_key_mode_direct': 'Personal key only',
    'settings.gemini_key_test': 'Test key',
    'settings.gemini_key_ok': 'Key works',
    'settings.gemini_key_invalid': 'Key rejected',
    'settings.ai_provider': 'AI provider',
    'settings.ai_provider_hint': 'Gemini works out of the box or with your own Gemini key; OpenAI needs your OpenAI key (or one provided by the server).',
    'settings.ai_provider_gemini': 'Google Gemini',
    'settings.ai_provider_openai': 'OpenAI (GPT)',
    'settings.openai_key': 'OpenAI API key — for GPT analysis and high-accuracy STT',
    'settings.openai_key_hint': 'Required for high-accuracy STT (starts with sk-). Stored unencrypted in this browser only.',
    'status.title': 'Speech recognition & AI',
    'status.refresh': 'Refresh',
    'status.chip_hint': 'Tap to check speech recognition and AI',
    'status.stt_title': 'Speech-to-text (STT)',
    'status.ai_title': 'AI analysis',
    'status.keys_title': 'API keys',
    'status.live': 'live',
    'status.engine': 'Engine',
    'status.model': 'Model',
    'status.auth': 'Key / access',
    'status.provider': 'Provider',
    'status.engine_cloud': 'Cloud high-accuracy (OpenAI Realtime)',
    'status.engine_whisper': 'Local Whisper (in browser)',
    'status.engine_webspeech': 'Browser built-in (Web Speech)',
    'status.engine_webspeech_local': 'Browser built-in, on-device',
    'status.engine_keyboard': 'Keyboard voice input',
    'status.engine_native': 'Native app recognizer',
    'status.model_browser': 'Google / OS recognizer (free)',
    'status.model_keyboard': 'Phone keyboard dictation (free)',
    'status.model_native': 'Device recognizer (free)',
    'status.auth_personal': 'Your personal key (from settings)',
    'status.auth_server': 'Server key (Vercel)',
    'status.auth_none': 'No key available',
    'status.auth_local': 'Runs locally, no key',
    'status.auth_free': 'Free, no key',
    'status.tier_light': 'Light',
    'status.tier_standard': 'Standard',
    'status.tier_heavy': 'Heavy (your pick)',
    'status.task_correction': 'correction', 'status.task_title': 'titles', 'status.task_metadata': 'metadata', 'status.task_tags': 'tags',
    'status.task_ocr': 'card OCR', 'status.task_refine': 'refine', 'status.task_prep': 'prep', 'status.task_prompt_adjuster': 'prompt tweaks',
    'status.task_chat': 'chat', 'status.task_analysis': 'live analysis', 'status.task_compare': 'compare', 'status.task_prompt_builder': 'prompt builder',
    'status.task_deep_setup': 'deep setup', 'status.task_minutes': 'minutes', 'status.task_docs': 'documents',
    'status.key_gemini': 'Gemini key (Gemini analysis)',
    'status.key_openai': 'OpenAI key (GPT analysis + cloud STT)',
    'status.key_server': 'Server OpenAI key for cloud STT',
    'status.key_set': 'set',
    'status.key_missing': 'not set',
    'status.keys_note': 'High-accuracy speech recognition needs an OpenAI key. Enter it below under "API key".',
    'status.problem_cloud_no_key': 'No OpenAI key yet — add one below under "API key" to use high-accuracy speech recognition.',
    'status.problem_whisper_not_downloaded': 'Whisper model not downloaded yet (Settings → Local Whisper).',
    'status.problem_ai_no_key': 'AI is not available: the server has no OpenAI key configured.',
    'status.ai_key_hint': 'Check the deployment settings.',
    'status.open_settings': 'Open settings',
    'status.close': 'Close',
    'status.advanced_info': 'Advanced info',
    'status.summary_stt': 'Speech recognition: {label}',
    'status.summary_ai': 'AI: {provider}',
    'status.summary_keys': 'API key: {keys}',
    'status.summary_key_server': 'Provided by server',
    'status.summary_key_personal': 'Personal key set',
    'status.summary_key_missing': 'Key needed',
    'status.summary_key_none_needed': 'Not needed (free)',
    'status.chip_checking': 'Checking…',
    'status.chip_ready': 'Speech recognition ready',
    'status.chip_live': 'Speech recognition connected',
    'status.chip_problem': 'Speech recognition problem',
    'status.summary_checking': 'Checking the connection…',
    'status.summary_ok': 'Speech recognition and AI both run on OpenAI through the server. All good.',
    'status.summary_problem': 'Something needs attention:',
    'status.problem_stt_fallback': 'Cloud speech recognition is unavailable (no server OpenAI key), so the browser\'s built-in recognizer is used instead.',
    'stt.cloud_no_key': 'Speech recognition is not available: the server has no OpenAI key configured.',
    'stt.cloud_rate_limited': 'High-accuracy STT: too many sessions from this network. Try again in a while.',
    'stt.cloud_mic_unavailable': 'High-accuracy STT: microphone unavailable ({reason}).',
    'stt.cloud_error': 'High-accuracy STT: {message}',
    'settings.openai_key_test': 'Test key',
    'settings.openai_key_ok': 'Key works',
    'settings.openai_key_invalid': 'Key rejected',
    'settings.model_tiers_hint': 'Light tasks (correction, titles, chat) use the light model; live analysis uses the standard model; only meeting minutes and documents use the model you pick here.',
    ...
    'settings.stt_engine_hint': 'Auto picks the best available option. Browser uses Web Speech in this tab. Keyboard voice input uses your phone\'s built-in dictation.',
    'settings.stt_engine_auto': 'Auto',
    'settings.stt_engine_webspeech': 'Browser (Web Speech)',
    'settings.stt_engine_keyboard': 'Keyboard voice input (phone\'s own STT)',
    'settings.stt_engine_cloud': 'Cloud high-accuracy (OpenAI)',
    'settings.stt_engine_whisper': 'Local Whisper (in-browser)',
    'settings.stt_on_device': 'Prefer on-device recognition',
    'settings.cloud_stt_model': 'Cloud STT model',
    'settings.cloud_stt_model_mini': 'Standard (~$0.003/min)',
    'settings.cloud_stt_model_full': 'High-accuracy (~$0.006/min)',
    'settings.cloud_stt_hint': 'OpenAI real-time transcription. Uses your OpenAI key from settings (or one provided by the server). A 1-hour meeting costs roughly $0.18-0.36.',
    'settings.whisper_model': 'Whisper model',
    'settings.whisper_download': 'Download model',
    'settings.whisper_delete': 'Delete',
    'settings.whisper_installed': 'Downloaded',
    'settings.whisper_not_installed': 'Not installed',
    'settings.whisper_unsupported': 'This browser is not supported',
    'settings.whisper_hint': 'A local model that runs in your browser. Once downloaded it works offline and your voice never leaves your device. Recommended for desktop.',
    'settings.keep_awake': 'Keep screen awake while recording',
    'settings.keep_awake_hint': 'Prevents the screen from turning off during a recording session.',
    ...
    'history.empty_title': 'No meetings yet',
    'history.empty_desc': 'Start a session and it will show up here automatically once you finish recording.',
    'history.empty_cta': 'Start a new session',
    ...
    'chat.faq_no_match': 'No matching prompts.',
    'chat.faq_save': 'Save',
    ...
    'meeting.launcher_record': 'Start recording now',
    'meeting.setup_options_title': 'Or set up first',
    'meeting.quick_start': 'Quick Start',
    'meeting.quick_start_desc': 'Chat with AI to set your meeting goal',
    ...
    'meeting.no_presets': 'No presets saved yet',
    'launcher.close': 'Close',
    'launcher.presets_title': 'Start with a preset',
    'launcher.presets_hint': 'Tap, check, start',
    'launcher.current_style': 'Current style: {name}',
    'launcher.more_title': 'More ways to set up',
    'launcher.ai_custom': 'Custom setup with AI',
    'launcher.saved_prep': 'Saved meeting prep',
    'launcher.my_preset': 'My preset',
    'qp.subject': 'Title / topic',
    'qp.subject_optional': '(optional)',
    'qp.focus': 'What the AI should watch for',
    'qp.questions': 'Suggested questions',
    'qp.one_per_line': 'One per line',
    'qp.start': 'Start now',
    'qp.ai_custom': 'Customize with AI',
    'qp.reset': 'Reset to defaults',
    'qp.reset_done': 'Restored the default settings',
    'qp.edited': 'Edited',
    'qp.close': 'Close',
    'qp.applied': 'Started with “{name}”',
    'meeting.ai_setup': 'Quick Start',
    'meeting.ai_setup_desc': 'AI sets up for your situation',
    'meeting.deep_setup': 'Meeting Prep',
    'meeting.deep_setup_desc': 'Enter attendees, materials and agenda ahead of time',
    'pb.title': 'Custom setup with AI',
    ...
    'ds.step3': 'AI Setup',
    'ds.step4': 'Ready',
    'ds.step3_files': 'Files',
    'ds.step4_ai': 'AI Setup',
    'ds.step5_ready': 'Ready',
    ...
    'ds.step4_greeting': 'Analyzing your meeting info...',
    'ds.step3_context_card': 'What AI knows',
    'ds.step4_title': 'Ready to go!',
    'ds.step5_title': 'Ready to go!',
    'ds.btn_start': '▶ Start',
    ...
    'asm.builtin_styles': 'Built-in Styles',
    'asm.confirm_delete': 'Delete this analysis style?',
    'asm.save_title': 'Save this analysis style',
    ...
    // UX: in-app dialogs (ui/dialogs.js)
    'sh.clear_all_confirm': 'Clear all history?',
    'sh.view_btn': 'View',
    'sh.restored': 'Restored to "{label}" style',
    'dialog.ok': 'OK',
    ...
    'dialog.reset': 'Reset',
    'dialog.add': 'Add',
    'auth.login_failed_title': 'Sign-in failed',
    'auth.login_failed': 'Could not sign in: {msg}',
    'sh.back': 'Back',
    ...
    'toast.wake_lock_failed': 'This device can’t keep the screen on automatically. Keep the screen on so recording isn’t interrupted.',
    'toast.gemini_fallback_active': 'Using your personal Gemini key',
    'toast.ai_unavailable': 'AI is unavailable: the server has no OpenAI key configured',
    ...
    'settings.danger_zone_hint': 'Resets every setting back to its default. Meetings are kept. This cannot be undone.',
    'settings.meeting_language': 'Meeting language',
    'settings.data_title': 'Data',
    'settings.backup_export': 'Export backup',
    'settings.backup_import': 'Restore from backup',
    'settings.backup_hint': 'One JSON file with every meeting, person, place, preset and setting. Audio recordings are not included.',
    'settings.backup_exported': 'Backup saved ({n} meetings).',
    'settings.backup_invalid': 'This file is not a Meeting AI backup.',
    'settings.backup_error': 'Backup failed. Please try again.',
    'settings.backup_import_confirm': 'Replace all current meetings and settings with this backup? The page will reload.',
    'settings.chat_custom': 'AI chat customization',
    'settings.account_title': 'Account & sync',
    'settings.manual_sync': 'Sync now',
    ...
    'import.subtitle': 'Bring your past recordings or transcripts into meeting-ai.',
    'import.subtitle': 'Bring your past recordings or transcripts into meeting-ai.',
    ...
    'usage.model_downgraded': 'Today\'s limit for the high-quality model is used up — using the light model instead.',
    ...
    'usage.cat.prep': 'prep',
    'usage.cat.pro_model': 'High-quality model (minutes, documents)',
    ...
    'end_meeting.audio_warn': 'Download recommended — auto-deleted after 30 days',
    ...
    // Preset Create Gateway
    'preset_create.title': 'Create Custom Preset',
    'preset_create.ai_title': 'Create with AI',
    'preset_create.ai_desc': 'Describe your situation and AI will create the optimal preset',
    'preset_create.manual_title': 'Manual Entry',
    'preset_create.manual_desc': 'Write prompts and settings yourself',

    // Preset Manual Form
    'preset_manual.title': 'Create Preset Manually',
    'preset_manual.name': 'Name *',
    'preset_manual.description': 'Description',
    'preset_manual.analysis_prompt': 'Analysis Prompt',
    'preset_manual.chat_system_prompt': 'Chat System Prompt',
    'preset_manual.chat_presets': 'Suggested Questions',
    'preset_manual.memo_hint': 'Memo Guide',
    'preset_manual.context': 'Context',
    'preset_manual.cancel': 'Cancel',
    'preset_manual.save': 'Save',
    'preset_manual.name_required': 'Please enter a preset name',
    'preset_manual.add_question_placeholder': 'Enter a question...',
    'preset_manual.saved': 'Preset saved!',
  ...
  ko: {
    ...
    'record.live_recording': '녹음 중',
    'record.live_paused': '일시정지됨',
    'record.live_aria': '녹음 상태',
    'record.status_stopped': '중지됨',
    'record.status_ended': '회의 종료됨 - 재개하거나 새 회의를 시작하세요',
    'session.resumed': '녹음이 재개되었습니다',
    'meeting.end_short': '미팅 종료',
    'bottom.more_controls': '더보기',
    'stt.engine_label': 'Web Speech',
    ...
    'stt.connection_failed': '음성 인식 연결이 끊겼어요. 자동으로 다시 연결하는 중이니 네트워크를 확인해 주세요.',
    ...
    'stt.kb_placeholder': '키보드의 마이크를 누르고 말씀하세요…',
    'stt.kb_send': '추가',
    'stt.kb_hint': '키보드 마이크로 말한 뒤 추가를 누르세요.',
    'stt.switch_to_keyboard': '음성 인식이 계속 실패합니다. 키보드 음성 입력으로 전환할까요?',
    'stt.switch_to_keyboard_action': '전환',
    'stt.on_device_active': '기기 내 인식이 활성화됨',
    'stt.high_accuracy': '고정확도 STT',
    'stt.high_accuracy_hint': 'OpenAI 실시간 전사로 전환합니다 (약 $0.003/분)',
    'stt.whisper_loading': 'Whisper 모델 로딩 중…',
    'stt.whisper_transcribing': '전사 중…',
    'privacy.badge': '비공개',
    ...
    'settings.gemini_key': 'Gemini API 키 — Gemini 분석용',
    'settings.gemini_placeholder': 'API 키 입력',
    'settings.gemini_key_hint': '이 브라우저에만 암호화 없이 저장됩니다. 서버 프록시를 쓸 수 없거나 요청 한도에 걸린 경우 사용됩니다.',
    'settings.gemini_key_mode': 'Gemini 키 사용 방식',
    'settings.gemini_key_mode_proxy': '서버 프록시만 사용',
    'settings.gemini_key_mode_fallback': '프록시 우선, 개인 키는 대체용',
    'settings.gemini_key_mode_direct': '개인 키만 사용',
    'settings.gemini_key_test': '키 테스트',
    'settings.gemini_key_ok': '키가 확인되었습니다',
    'settings.gemini_key_invalid': '키가 거부되었습니다',
    'settings.ai_provider': 'AI 제공자',
    'settings.ai_provider_hint': 'Gemini는 별도 설정 없이 쓰거나 내 Gemini 키로 쓸 수 있어요. OpenAI는 내 OpenAI 키(또는 서버에서 제공하는 키)가 필요해요.',
    'settings.ai_provider_gemini': 'Google Gemini',
    'settings.ai_provider_openai': 'OpenAI (GPT)',
    'settings.openai_key': 'OpenAI API 키 — GPT 분석 + 고정확도 STT용',
    'settings.openai_key_hint': '고정확도 STT에 필요합니다 (sk-로 시작). 이 브라우저에만 암호화 없이 저장됩니다.',
    'status.title': '음성 인식 · AI 상태',
    'status.refresh': '새로고침',
    'status.chip_hint': '눌러서 음성 인식과 AI 상태 확인',
    'status.stt_title': '음성 인식 (STT)',
    'status.ai_title': 'AI 분석',
    'status.keys_title': 'API 키',
    'status.live': '동작 중',
    'status.engine': '엔진',
    'status.model': '모델',
    'status.auth': '키 / 접근',
    'status.provider': '제공자',
    'status.engine_cloud': '클라우드 고정확도 (OpenAI 실시간 전사)',
    'status.engine_whisper': '로컬 Whisper (브라우저)',
    'status.engine_webspeech': '브라우저 내장 (Web Speech)',
    'status.engine_webspeech_local': '브라우저 내장, 온디바이스',
    'status.engine_keyboard': '키보드 음성입력',
    'status.engine_native': '네이티브 앱 인식기',
    'status.model_browser': 'Google / OS 인식기 (무료)',
    'status.model_keyboard': '폰 키보드 받아쓰기 (무료)',
    'status.model_native': '기기 인식기 (무료)',
    'status.auth_personal': '개인 키 (설정에 입력한 키)',
    'status.auth_server': '서버 키 (Vercel)',
    'status.auth_none': '사용 가능한 키 없음',
    'status.auth_local': '로컬 실행, 키 불필요',
    'status.auth_free': '무료, 키 불필요',
    'status.tier_light': '가벼움',
    'status.tier_standard': '표준',
    'status.tier_heavy': '무거움 (직접 선택)',
    'status.task_correction': '문장 교정', 'status.task_title': '제목', 'status.task_metadata': '메타데이터', 'status.task_tags': '태그',
    'status.task_ocr': '명함 OCR', 'status.task_refine': '다듬기', 'status.task_prep': '회의 준비', 'status.task_prompt_adjuster': '프롬프트 미세조정',
    'status.task_chat': '채팅', 'status.task_analysis': '실시간 분석', 'status.task_compare': '프롬프트 비교', 'status.task_prompt_builder': '프롬프트 빌더',
    'status.task_deep_setup': '딥 셋업', 'status.task_minutes': '회의록', 'status.task_docs': '문서 생성',
    'status.key_gemini': 'Gemini 키 (Gemini 분석용)',
    'status.key_openai': 'OpenAI 키 (GPT 분석 + 고정확도 STT)',
    'status.key_server': '서버 OpenAI 키 (고정확도 STT용)',
    'status.key_set': '설정됨',
    'status.key_missing': '없음',
    'status.keys_note': '고정확도 음성 인식을 쓰려면 OpenAI 키가 필요해요. 아래 \'API 키\'에서 입력하세요.',
    'status.problem_cloud_no_key': '아직 OpenAI 키가 없어요. 아래 \'API 키\'에서 입력하면 고정확도 음성 인식을 쓸 수 있어요.',
    'status.problem_whisper_not_downloaded': 'Whisper 모델이 아직 다운로드되지 않았습니다 (설정 → 로컬 Whisper).',
    'status.problem_ai_no_key': 'AI를 쓸 수 없습니다: 서버에 OpenAI 키가 설정되어 있지 않습니다.',
    'status.ai_key_hint': '배포 설정을 확인하세요.',
    'status.open_settings': '설정 열기',
    'status.close': '닫기',
    'status.advanced_info': '고급 정보',
    'status.summary_stt': '음성 인식: {label}',
    'status.summary_ai': 'AI: {provider}',
    'status.summary_keys': 'API 키: {keys}',
    'status.summary_key_server': '서버 제공',
    'status.summary_key_personal': '개인 키 설정됨',
    'status.summary_key_missing': '키 필요',
    'status.summary_key_none_needed': '필요 없음 (무료)',
    'status.chip_checking': '확인 중…',
    'status.chip_ready': '음성 인식 준비됨',
    'status.chip_live': '음성 인식 연결됨',
    'status.chip_problem': '음성 인식 문제',
    'status.summary_checking': '연결 상태를 확인하는 중입니다…',
    'status.summary_ok': '음성 인식과 AI 모두 서버를 통해 OpenAI로 정상 동작 중입니다.',
    'status.summary_problem': '확인이 필요합니다:',
    'status.problem_stt_fallback': '클라우드 음성 인식을 쓸 수 없어(서버 OpenAI 키 없음) 브라우저 내장 인식으로 대체합니다.',
    'stt.cloud_no_key': '음성 인식을 쓸 수 없습니다: 서버에 OpenAI 키가 설정되어 있지 않습니다.',
    'stt.cloud_rate_limited': '고정확도 STT: 이 네트워크에서 세션이 너무 많습니다. 잠시 후 다시 시도하세요.',
    'stt.cloud_mic_unavailable': '고정확도 STT: 마이크를 쓸 수 없습니다 ({reason}).',
    'stt.cloud_error': '고정확도 STT: {message}',
    'settings.openai_key_test': '키 테스트',
    'settings.openai_key_ok': '키가 확인되었습니다',
    'settings.openai_key_invalid': '키가 거부되었습니다',
    'settings.model_tiers_hint': '가벼운 작업(교정, 제목, 채팅)은 라이트 모델을, 실시간 분석은 표준 모델을 사용합니다. 회의록과 문서에만 여기서 선택한 모델이 사용됩니다.',
    'settings.stt': 'STT 설정',
    ...
    'settings.stt_engine': '음성 인식 엔진',
    'settings.stt_engine_hint': '자동은 가능한 최적 방식을 선택합니다. 브라우저는 이 탭의 Web Speech를 사용합니다. 키보드 음성 입력은 휴대폰 자체 받아쓰기를 사용합니다.',
    'settings.stt_engine_auto': '자동',
    'settings.stt_engine_webspeech': '브라우저 (Web Speech)',
    'settings.stt_engine_keyboard': '키보드 음성 입력 (휴대폰 자체 STT)',
    'settings.stt_engine_cloud': '클라우드 고정확도 (OpenAI)',
    'settings.stt_engine_whisper': '로컬 Whisper (브라우저)',
    'settings.stt_on_device': '기기 내 인식 우선',
    'settings.cloud_stt_model': '클라우드 STT 모델',
    'settings.cloud_stt_model_mini': '표준 (약 $0.003/분)',
    'settings.cloud_stt_model_full': '고정확도 (약 $0.006/분)',
    'settings.cloud_stt_hint': 'OpenAI 실시간 받아쓰기. 설정에 입력한 OpenAI 키(또는 서버 제공 키)를 사용해요. 1시간 회의 ≈ $0.18–0.36',
    'settings.whisper_model': 'Whisper 모델',
    'settings.whisper_download': '모델 다운로드',
    'settings.whisper_delete': '삭제',
    'settings.whisper_installed': '다운로드됨',
    'settings.whisper_not_installed': '미설치',
    'settings.whisper_unsupported': '이 브라우저는 지원하지 않습니다',
    'settings.whisper_hint': '브라우저에서 실행되는 로컬 모델. 한 번 내려받으면 오프라인에서도 동작하고 음성이 외부로 나가지 않습니다. 데스크톱 권장.',
    'settings.keep_awake': '녹음 중 화면 켜두기',
    'settings.keep_awake_hint': '녹음하는 동안 화면이 꺼지지 않도록 합니다.',
    ...
    'history.empty_title': '아직 저장된 회의가 없어요',
    'history.empty_desc': '새 세션을 시작하고 녹음을 마치면 여기에 자동으로 기록돼요.',
    'history.empty_cta': '새 세션 시작',
    ...
    'chat.faq_no_match': '일치하는 프롬프트가 없습니다.',
    'chat.faq_save': '저장',
    ...
    'meeting.launcher_record': '바로 녹음 시작',
    'meeting.setup_options_title': '또는 설정하고 시작하기',
    'meeting.quick_start': '빠른 시작',
    'meeting.quick_start_desc': 'AI와 대화로 회의 목적 설정',
    ...
    'meeting.no_presets': '저장된 프리셋이 없어요',
    'launcher.close': '닫기',
    'launcher.presets_title': '프리셋으로 바로 시작',
    'launcher.presets_hint': '탭 → 확인 → 시작',
    'launcher.current_style': '현재 스타일: {name}',
    'launcher.more_title': '다른 방법으로 설정',
    'launcher.ai_custom': 'AI와 맞춤 설정',
    'launcher.saved_prep': '저장된 회의 준비',
    'launcher.my_preset': '내 프리셋',
    'qp.subject': '제목 / 주제',
    'qp.subject_optional': '(선택)',
    'qp.focus': 'AI가 챙길 것',
    'qp.questions': '추천 질문',
    'qp.one_per_line': '한 줄에 하나씩',
    'qp.start': '바로 시작',
    'qp.ai_custom': 'AI와 맞춤 설정',
    'qp.reset': '기본값으로 되돌리기',
    'qp.reset_done': '기본 설정으로 되돌렸어요',
    'qp.edited': '수정됨',
    'qp.close': '닫기',
    'qp.applied': '“{name}” 설정으로 시작했어요',
    'meeting.ai_setup': '빠른 시작',
    'meeting.ai_setup_desc': 'AI가 상황에 맞게 설정',
    'meeting.deep_setup': '회의 사전 준비',
    'meeting.deep_setup_desc': '참석자·자료·안건을 미리 입력',
    'pb.title': 'AI와 맞춤 설정',
    ...
    'asm.builtin_styles': '기본 스타일',
    'asm.confirm_delete': '이 분석 스타일을 삭제할까요?',
    'asm.save_title': '이 분석 스타일 저장',
    ...
    // UX: in-app dialogs (ui/dialogs.js)
    'sh.clear_all_confirm': '모든 이력을 삭제하시겠습니까?',
    'sh.view_btn': '보기',
    'sh.restored': '"{label}" 스타일로 복원했습니다',
    'dialog.ok': '확인',
    'dialog.cancel': '취소',
    'dialog.delete': '삭제',
    'dialog.save': '저장',
    'dialog.load': '불러오기',
    'dialog.resume': '이어서 녹음',
    'dialog.send': '전송',
    'dialog.reset': '초기화',
    'dialog.add': '추가',
    'auth.login_failed_title': '로그인 실패',
    'auth.login_failed': '로그인하지 못했습니다: {msg}',
    'sh.back': '뒤로',
    ...
    'toast.wake_lock_failed': '이 기기에서는 화면 켜짐 유지를 자동으로 설정할 수 없어요. 녹음이 끊기지 않도록 화면을 켜 두세요.',
    'toast.gemini_fallback_active': '개인 Gemini 키를 사용 중입니다',
    'toast.ai_unavailable': 'AI를 사용할 수 없습니다: 서버에 OpenAI 키가 설정되어 있지 않습니다',
    ...
    'settings.danger_zone_title': '위험 구역',
    'settings.danger_zone_hint': '모든 설정을 기본값으로 되돌립니다. 회의 기록은 그대로 남습니다. 이 작업은 되돌릴 수 없습니다.',
    'settings.meeting_language': '회의 언어',
    'settings.data_title': '데이터',
    'settings.backup_export': '백업 내보내기',
    'settings.backup_import': '백업에서 복원',
    'settings.backup_hint': '모든 회의·사람·장소·프리셋·설정을 JSON 파일 하나로 저장합니다. 녹음 파일은 포함되지 않습니다.',
    'settings.backup_exported': '백업을 저장했습니다 (회의 {n}개).',
    'settings.backup_invalid': 'Meeting AI 백업 파일이 아닙니다.',
    'settings.backup_error': '백업 처리에 실패했습니다. 다시 시도하세요.',
    'settings.backup_import_confirm': '현재 회의와 설정을 모두 이 백업으로 바꿀까요? 페이지가 새로고침됩니다.',
    'settings.chat_custom': 'AI 채팅 맞춤 설정',
    'settings.account_title': '계정 · 동기화',
    'settings.manual_sync': '지금 동기화',
    ...
    'import.subtitle': '지난 녹음이나 녹취록을 meeting-ai로 가져오세요.',
    ...
    'usage.model_downgraded': '오늘 고품질 모델 사용 한도를 다 써서 가벼운 모델로 대체합니다.',
    ...
    'usage.cat.pro_model': '고품질 모델 (회의록·문서)',
    ...
    'end_meeting.audio_warn': '다운로드를 권장합니다 — 30일 후 자동 삭제됩니다',
    ...
    // Preset Create Gateway
    'preset_create.title': '새 프리셋 만들기',
    'preset_create.ai_title': 'AI로 만들기',
    'preset_create.ai_desc': '상황을 설명하면 AI가 최적의 프리셋을 만들어줍니다',
    'preset_create.manual_title': '수동으로 입력',
    'preset_create.manual_desc': '프롬프트와 설정을 직접 작성합니다',

    // Preset Manual Form
    'preset_manual.title': '프리셋 직접 만들기',
    'preset_manual.name': '이름 *',
    'preset_manual.description': '설명',
    'preset_manual.analysis_prompt': '분석 프롬프트',
    'preset_manual.chat_system_prompt': '채팅 시스템 프롬프트',
    'preset_manual.chat_presets': '추천 질문',
    'preset_manual.memo_hint': '메모 가이드',
    'preset_manual.context': '상황 배경',
    'preset_manual.cancel': '취소',
    'preset_manual.save': '저장',
    'preset_manual.name_required': '프리셋 이름을 입력해주세요',
    'preset_manual.add_question_placeholder': '질문 입력...',
    'preset_manual.saved': '프리셋이 저장되었습니다!',
