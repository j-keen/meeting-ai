...
const translations = {
  en: {
    ...
    'minutes_preview.prompt_edit': 'Minutes Style',
    ...
    'minutes_preview.prompt_reference_hint': 'Paste reference minutes here...',
    'minutes_preview.prompt_base': 'Base Prompt',
    'minutes_preview.prompt_instruction': 'User Instruction',
    'minutes_preview.prompt_instruction_hint': 'e.g., Focus on action items',
  ...
  ko: {
    ...
    'minutes_preview.prompt_edit': '스타일 변경',
    ...
    'minutes_preview.prompt_reference_hint': '참고할 회의록을 붙여넣으세요',
    'minutes_preview.prompt_base': '기본 프롬프트 변경',
    'minutes_preview.prompt_instruction': '사용자 지시문 추가',
    'minutes_preview.prompt_instruction_hint': '예: 액션 아이템 중심으로 작성',
