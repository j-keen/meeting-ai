...
const translations = {
  en: {
    ...
    'memo.placeholder.1': "e.g. 'This part was said by Director Lee, not Director Kim'",
    'memo.placeholder.2': "e.g. 'Decision made here — complete by next week'",
    'memo.placeholder.3': "e.g. 'I think this agenda item needs reconsideration'",
    'memo.add': 'Add',
    'hint.transcript_edit': 'Tap to edit · improves AI quality',
    'hint.analysis_edit': 'Click blocks to edit · reflected in next analysis',
  ...
  ko: {
    ...
    'memo.placeholder.1': "예: '이 부분은 김 부장이 아니라 이 부장이 말한 거예요'",
    'memo.placeholder.2': "예: '여기서 결정된 사항 — 다음 주까지 완료'",
    'memo.placeholder.3': "예: '이 안건은 재검토가 필요하다고 생각함'",
    'memo.add': '추가',
    'hint.transcript_edit': '탭하여 수정 · AI 품질 향상에 반영',
