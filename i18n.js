...
const translations = {
  en: {
    ...
    'memo.add': 'Add',
    'hint.transcript_edit.0': 'Double-click to edit · improves AI quality',
    'hint.transcript_edit.1': 'Edits make the AI smarter',
    'hint.transcript_edit.2': 'Add context for better analysis',
    'hint.transcript_edit.3': 'More edits, better results',
    'hint.transcript_edit.4': 'Your input is the AI\'s hint',
    'hint.analysis_edit.0': 'Click blocks to edit · reflected in next analysis',
    'hint.analysis_edit.1': 'Edits improve the next analysis',
    'hint.analysis_edit.2': 'Feedback improves AI accuracy',
    'hint.analysis_edit.3': 'More fixes, better meeting insight',
    'hint.analysis_edit.4': 'One edit raises analysis quality',
  ...
  ko: {
    ...
    'memo.add': '추가',
    'hint.transcript_edit.0': '더블클릭하여 수정 · AI 품질 향상에 반영',
    'hint.transcript_edit.1': '수정하면 AI가 더 똑똑해져요',
    'hint.transcript_edit.2': '맥락을 추가하면 분석이 좋아져요',
    'hint.transcript_edit.3': '수정할수록 결과가 좋아져요',
    'hint.transcript_edit.4': '입력이 곧 AI의 힌트예요',
    'hint.analysis_edit.0': '블록 클릭하여 수정 · 다음 분석에 반영',
    'hint.analysis_edit.1': '수정하면 다음 분석이 더 정확해요',
    'hint.analysis_edit.2': '피드백이 AI 정확도를 높여요',
    'hint.analysis_edit.3': '고칠수록 AI가 회의를 잘 파악해요',
    'hint.analysis_edit.4': '한 줄의 수정이 분석 품질을 높여요',
    'meeting.end': '회의 종료',
    'meeting.resume': '재개',
    'meeting.export': '내보내기',
    'meeting.new': '새 회의',
