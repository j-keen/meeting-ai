...
const translations = {
  en: {
    ...
    'status.title': 'Current engines & models',
    'status.refresh': 'Refresh',
    'status.chip_hint': 'Tap to see which STT engine, model and key are in use',
    ...
    'status.problem_ai_no_key': 'No AI access: no server proxy and no personal key for this provider.',
    'status.ai_key_hint': 'Add your own key in Settings → API key.',
    ...
    'stt.cloud_no_key': 'High-accuracy STT needs an OpenAI key. Enter it in Settings → OpenAI API key.',
    ...
    'toast.ai_unavailable': 'AI is unavailable: no server proxy and no personal key',
    ...
    'settings.danger_zone_hint': 'Resets every setting below back to its default. This cannot be undone.',
  ...
  ko: {
    ...
    'status.title': '현재 사용 중인 엔진·모델',
    'status.refresh': '새로고침',
    'status.chip_hint': '눌러서 지금 어떤 STT 엔진·모델·키를 쓰는지 보기',
    ...
    'status.problem_ai_no_key': 'AI를 쓸 수 없습니다. 서버 프록시도, 이 제공자의 개인 키도 없습니다.',
    'status.ai_key_hint': '설정 → API 키에서 개인 키를 입력하세요.',
    ...
    'stt.cloud_no_key': '고정확도 STT를 쓰려면 OpenAI 키가 필요합니다. 설정 → OpenAI API 키에 입력하세요.',
    ...
    'toast.ai_unavailable': 'AI를 사용할 수 없습니다: 서버 프록시와 개인 키가 없습니다',
    ...
    'settings.danger_zone_hint': '아래 모든 설정을 기본값으로 되돌립니다. 이 작업은 되돌릴 수 없습니다.',
