...
const translations = {
  en: {
    ...
    'memo.add': 'Add',
    // Transcript hints — L0 (0 edits): basics
    'hint.transcript.L0.idle.0': 'Double-click any line to fix typos — AI uses your corrections',
    'hint.transcript.L0.idle.1': 'Mis-heard "react" as "re-act"? Double-click to fix it',
    'hint.transcript.L0.idle.2': 'Editing a line teaches AI the correct term for next time',
    'hint.transcript.L0.rec0.0': 'Recording started — lines will appear as you speak',
    'hint.transcript.L0.rec0.1': 'Speak clearly near the mic for best recognition',
    'hint.transcript.L0.rec1.0': 'See a wrong word? Double-click the line to correct it',
    'hint.transcript.L0.rec1.1': 'Fix names and jargon so AI analysis is accurate',
    'hint.transcript.L0.rec1.2': 'Each correction improves the next AI analysis cycle',
    'hint.transcript.L0.analyzed.0': 'Check transcript for errors — your edits refine the analysis',
    'hint.transcript.L0.analyzed.1': 'Wrong name? Fix it here — next analysis picks it up',
    'hint.transcript.L0.ended.0': 'Review & fix transcript before exporting',
    'hint.transcript.L0.ended.1': 'Edits are saved — clean up before sharing',

    // Transcript hints — L1 (1-5 edits): why it matters
    'hint.transcript.L1.idle.0': 'Your edits are sent as corrections in the next analysis prompt',
    'hint.transcript.L1.idle.1': 'AI compares before/after to learn your meeting vocabulary',
    'hint.transcript.L1.rec0.0': 'Recording — your past edits already improve this session',
    'hint.transcript.L1.rec1.0': 'Correcting jargon like "K8s" helps AI use it consistently',
    'hint.transcript.L1.rec1.1': 'Edit nearby lines together — AI sees grouped corrections',
    'hint.transcript.L1.analyzed.0': 'Your corrections were included in this analysis',
    'hint.transcript.L1.analyzed.1': 'Spot something new? Edit it — next cycle picks it up',
    'hint.transcript.L1.ended.0': 'Final edits still improve the saved meeting record',

    // Transcript hints — L2 (6-19 edits): power user
    'hint.transcript.L2.idle.0': 'Pro tip: add context in memo bar — AI merges it with edits',
    'hint.transcript.L2.idle.1': 'Bookmark key moments with Ctrl+B for quick review later',
    'hint.transcript.L2.rec1.0': 'Try the correction dictionary in Settings for recurring terms',
    'hint.transcript.L2.rec1.1': 'Memo bar accepts opinions too — "focus on budget risks"',
    'hint.transcript.L2.analyzed.0': 'Use "Analyze Now" after a batch of edits for instant refresh',
    'hint.transcript.L2.ended.0': 'Export to Markdown or PDF from the panel menu',

    // Analysis hints — L0 (0 edits): basics
    'hint.analysis.L0.idle.0': 'AI analysis appears automatically during recording',
    'hint.analysis.L0.idle.1': 'Analysis updates every cycle — edits are reflected next round',
    'hint.analysis.L0.rec0.0': 'Analysis will generate after enough transcript accumulates',
    'hint.analysis.L0.rec1.0': 'Click any analysis block to edit — changes feed back to AI',
    'hint.analysis.L0.rec1.1': 'Wrong summary? Click to fix — AI adjusts in the next cycle',
    'hint.analysis.L0.analyzed.0': 'Click a section heading to edit that block',
    'hint.analysis.L0.analyzed.1': 'Your edit is sent as a "user correction" in the next prompt',
    'hint.analysis.L0.analyzed.2': 'Try editing a bullet point — AI preserves your version',
    'hint.analysis.L0.ended.0': 'Review analysis blocks before saving the meeting',
    'hint.analysis.L0.ended.1': 'Click to edit — final version is what gets exported',

    // Analysis hints — L1 (1-5 edits): mechanism
    'hint.analysis.L1.idle.0': 'Your block edits are appended as corrections to the AI prompt',
    'hint.analysis.L1.idle.1': 'AI sees "before → after" diffs so it learns your preference',
    'hint.analysis.L1.rec1.0': 'Edit analysis while recording — next cycle includes your fix',
    'hint.analysis.L1.rec1.1': 'Combine transcript + analysis edits for best results',
    'hint.analysis.L1.analyzed.0': 'Each edited block is marked — AI won\'t overwrite your version',
    'hint.analysis.L1.analyzed.1': 'Use "Analyze Now" to see your corrections applied immediately',
    'hint.analysis.L1.ended.0': 'Polish the analysis — it becomes the final meeting record',

    // Analysis hints — L2 (6-19 edits): power user
    'hint.analysis.L2.idle.0': 'Customize the analysis prompt in AI Analysis Settings',
    'hint.analysis.L2.rec1.0': 'Try different analysis prompts for different meeting types',
    'hint.analysis.L2.analyzed.0': 'Use Compare mode to test prompt variations side-by-side',
    'hint.analysis.L2.analyzed.1': 'Refine a single section via right-click → AI Refine',
    'hint.analysis.L2.ended.0': 'Generate formal minutes from the end-meeting flow',
    ...
    'settings.location_gps_saved': 'GPS coordinates saved',
    ...
    'settings.location_group_all': 'All',
    'settings.location_group_none': 'No group',
    'settings.location_group_ungrouped': 'Ungrouped',
    'settings.location_group_name_prompt': 'Enter group name:',
    'settings.location_group_delete_confirm': 'Delete group "{name}"? Locations will be ungrouped.',
    ...
    'meeting.ai_setup': 'AI Setup',
    'meeting.ai_setup_desc': 'AI creates a custom setup for you',
    'pb.title': 'AI Setup',
    'pb.input_placeholder': 'Describe your situation...',
    'pb.back_to_chat': '← Back to Chat',
    'pb.save_preset': '💾 Save as Preset',
    'pb.start': '▶ Start',
    'pb.greeting': 'What situation will you be using this for?\n\nFor example:\n• "I have a doctor\'s appointment and want to record it"\n• "It\'s a code review session, organize it for me"\n• "I want to organize my ideas by myself"',
    'pb.or_describe': 'Or describe your situation:',
    'pb.generating': 'Generating your custom setup...',
    ...
    'pb.chip_medical': 'Medical Consultation',
    'pb.chip_legal': 'Legal Consultation',
    'pb.chip_code_review': 'Code Review',
    'pb.chip_lecture': 'Lecture',
    'pb.chip_interview': 'Interview',
    'pb.chip_brainstorm': 'Brainstorming',
    'pb.chip_customer': 'Customer Meeting',
    'pb.chip_voice_memo': 'Voice Memo',
    ...
    'settings.contacts_import': 'Add from File',
    'settings.export_csv': 'Save as Excel',
    'settings.export_vcf': 'Save as Contacts',
    'settings.contacts_imported': 'contacts imported',
  ...
  ko: {
    ...
    'memo.add': '추가',
    // Transcript hints — L0 (0 edits): 기초
    'hint.transcript.L0.idle.0': '줄을 더블클릭하면 오타를 수정할 수 있어요 — AI가 반영해요',
    'hint.transcript.L0.idle.1': '"리액트"가 "리 액트"로 잘못 인식됐다면? 더블클릭으로 수정',
    'hint.transcript.L0.idle.2': '줄을 수정하면 AI가 올바른 용어를 다음에 반영해요',
    'hint.transcript.L0.rec0.0': '녹음 시작 — 말하면 자막이 나타나요',
    'hint.transcript.L0.rec0.1': '마이크 가까이서 또렷하게 말하면 인식률이 올라가요',
    'hint.transcript.L0.rec1.0': '잘못된 단어가 보이면 더블클릭해서 수정하세요',
    'hint.transcript.L0.rec1.1': '이름과 전문용어를 수정하면 AI 분석이 정확해져요',
    'hint.transcript.L0.rec1.2': '수정할 때마다 다음 AI 분석 사이클이 개선돼요',
    'hint.transcript.L0.analyzed.0': '녹취를 확인하고 수정하세요 — 분석이 더 정확해져요',
    'hint.transcript.L0.analyzed.1': '이름이 틀렸다면 여기서 수정 — 다음 분석에 반영돼요',
    'hint.transcript.L0.ended.0': '내보내기 전에 녹취를 검토하고 수정하세요',
    'hint.transcript.L0.ended.1': '수정 사항은 저장돼요 — 공유 전에 정리하세요',

    // Transcript hints — L1 (1-5 edits): 이유 설명
    'hint.transcript.L1.idle.0': '수정 내용이 다음 분석 프롬프트에 교정으로 전달돼요',
    'hint.transcript.L1.idle.1': 'AI가 수정 전후를 비교해서 회의 용어를 학습해요',
    'hint.transcript.L1.rec0.0': '녹음 중 — 이전 수정이 이미 이번 세션에 반영돼요',
    'hint.transcript.L1.rec1.0': '"K8s" 같은 전문용어를 수정하면 AI가 일관되게 사용해요',
    'hint.transcript.L1.rec1.1': '근처 줄을 함께 수정하면 AI가 묶어서 인식해요',
    'hint.transcript.L1.analyzed.0': '수정 사항이 이번 분석에 포함됐어요',
    'hint.transcript.L1.analyzed.1': '새로운 오류 발견? 수정하면 다음 사이클에 반영돼요',
    'hint.transcript.L1.ended.0': '최종 수정도 저장된 회의 기록에 반영돼요',

    // Transcript hints — L2 (6-19 edits): 고급 팁
    'hint.transcript.L2.idle.0': '팁: 메모 바에 맥락을 추가하면 AI가 수정과 합쳐서 분석해요',
    'hint.transcript.L2.idle.1': 'Ctrl+B로 중요 순간을 북마크하면 나중에 빠르게 찾아요',
    'hint.transcript.L2.rec1.0': '설정의 교정 사전으로 반복되는 용어를 자동 수정하세요',
    'hint.transcript.L2.rec1.1': '메모 바에 의견도 입력 가능 — "예산 리스크에 집중"',
    'hint.transcript.L2.analyzed.0': '수정 후 "지금 분석"을 누르면 바로 반영돼요',
    'hint.transcript.L2.ended.0': '패널 메뉴에서 Markdown이나 PDF로 내보내기',

    // Analysis hints — L0 (0 edits): 기초
    'hint.analysis.L0.idle.0': '녹음 중 AI 분석이 자동으로 생성돼요',
    'hint.analysis.L0.idle.1': '분석은 주기적으로 업데이트 — 수정은 다음 라운드에 반영',
    'hint.analysis.L0.rec0.0': '충분한 녹취가 쌓이면 분석이 자동 생성돼요',
    'hint.analysis.L0.rec1.0': '분석 블록을 클릭해서 수정 — 변경이 AI에 피드백돼요',
    'hint.analysis.L0.rec1.1': '요약이 틀렸다면 클릭해서 수정 — 다음 사이클에 반영돼요',
    'hint.analysis.L0.analyzed.0': '섹션 제목을 클릭하면 해당 블록을 수정할 수 있어요',
    'hint.analysis.L0.analyzed.1': '수정이 다음 프롬프트에 "사용자 교정"으로 전달돼요',
    'hint.analysis.L0.analyzed.2': '항목을 수정해보세요 — AI가 수정본을 유지해요',
    'hint.analysis.L0.ended.0': '저장 전에 분석 블록을 검토하세요',
    'hint.analysis.L0.ended.1': '클릭해서 수정 — 최종본이 내보내기에 사용돼요',

    // Analysis hints — L1 (1-5 edits): 메커니즘
    'hint.analysis.L1.idle.0': '블록 수정이 AI 프롬프트에 교정으로 추가돼요',
    'hint.analysis.L1.idle.1': 'AI가 "수정 전→후" 차이를 보고 선호를 학습해요',
    'hint.analysis.L1.rec1.0': '녹음 중에도 분석 수정 가능 — 다음 사이클에 포함돼요',
    'hint.analysis.L1.rec1.1': '녹취 + 분석 수정을 함께하면 최고의 결과를 얻어요',
    'hint.analysis.L1.analyzed.0': '수정된 블록은 표시돼요 — AI가 덮어쓰지 않아요',
    'hint.analysis.L1.analyzed.1': '"지금 분석"으로 수정 사항을 바로 확인하세요',
    'hint.analysis.L1.ended.0': '분석을 다듬으세요 — 최종 회의 기록이 돼요',

    // Analysis hints — L2 (6-19 edits): 고급 팁
    'hint.analysis.L2.idle.0': 'AI 분석 설정에서 분석 프롬프트를 커스터마이즈하세요',
    'hint.analysis.L2.rec1.0': '회의 유형별로 다른 분석 프롬프트를 시도해보세요',
    'hint.analysis.L2.analyzed.0': '비교 모드로 프롬프트 변형을 나란히 테스트하세요',
    'hint.analysis.L2.analyzed.1': '우클릭 → AI 리파인으로 개별 섹션을 다듬으세요',
    'hint.analysis.L2.ended.0': '회의 종료 흐름에서 정식 회의록을 생성하세요',
    'meeting.end': '회의 종료',
    'meeting.resume': '재개',
    'meeting.export': '내보내기',
    'meeting.new': '새 회의',
    ...
    'settings.location_gps_saved': 'GPS 좌표가 저장되었습니다',
    ...
    'settings.location_group_all': '전체',
    'settings.location_group_none': '그룹 없음',
    'settings.location_group_ungrouped': '미분류',
    'settings.location_group_name_prompt': '그룹 이름을 입력하세요:',
    'settings.location_group_delete_confirm': '"{name}" 그룹을 삭제할까요? 장소는 미분류로 이동합니다.',
    ...
    'meeting.ai_setup': 'AI 셋업',
    'meeting.ai_setup_desc': 'AI가 맞춤 설정을 만들어드립니다',
    'pb.title': 'AI 셋업',
    'pb.input_placeholder': '어떤 상황인지 설명해주세요...',
    'pb.back_to_chat': '← 대화로 돌아가기',
    'pb.save_preset': '💾 프리셋 저장',
    'pb.start': '▶ 시작',
    'pb.greeting': '어떤 상황에서 사용하실 건가요?\n\n예를 들어:\n• "의사 상담 받는데 기록하고 싶어"\n• "코드 리뷰 세션인데 정리해줘"\n• "혼자 아이디어 정리하려고"',
    'pb.or_describe': '또는 직접 설명해주세요:',
    'pb.generating': '맞춤 설정을 생성하고 있습니다...',
    ...
    'pb.chip_medical': '의료 상담',
    'pb.chip_legal': '법률 상담',
    'pb.chip_code_review': '코드 리뷰',
    'pb.chip_lecture': '강의 수강',
    'pb.chip_interview': '면접',
    'pb.chip_brainstorm': '브레인스토밍',
    'pb.chip_customer': '고객 상담',
    'pb.chip_voice_memo': '보이스 메모',
    ...
    'settings.contacts_import': '파일에서 추가',
    'settings.export_csv': '엑셀로 저장',
    'settings.export_vcf': '연락처로 저장',
    'settings.contacts_imported': '개 연락처 가져옴',
